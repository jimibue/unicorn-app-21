...
ActiveRecord::Schema.define(version: 2021_04_13_182636) do
  ...
  create_table "trustees", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["trustee_id"], name: "index_trustees_on_trustee_id"
  ...
  add_foreign_key "trustees", "users", column: "trustee_id"
end

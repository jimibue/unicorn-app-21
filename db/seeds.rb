...
Bitz.create(user_id: sally.id,issuer_id:usa_citizenship.id,  bitz_def_id: usa_citizenship.id)
Bitz.create(user_id: sally.id,issuer_id:q_usa_citizenship.id, bitz_def_id: q_usa_citizenship.id)

us_dob = BitzDef.create(user_id:usa_government.id, name:'dob')
Bitz.create(user_id: sally.id,issuer_id:usa_citizenship.id,  bitz_def_id: us_dob.id, value:'6.27.67')

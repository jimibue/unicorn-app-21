...
Bitz.create(user_id: james.id, bitz_def_id: cvsCovidVac.id)
Bitz.create(user_id: sally.id, bitz_def_id: cvsCovidVac.id)

# in UI cvs create Defintion
jamesThinksYouCool = BitzDef.create(user_id:james.id, name:'You cool')
Bitz.create(user_id: sally.id, bitz_def_id: jamesThinksYouCool.id)
Bitz.create(user_id: delta.id, bitz_def_id: jamesThinksYouCool.id)

tomBradyThinksYouCool = BitzDef.create(user_id:tom_brady.id, name:'You cool')
Bitz.create(user_id: sally.id, bitz_def_id: tomBradyThinksYouCool.id)
Bitz.create(user_id: delta.id, bitz_def_id: tomBradyThinksYouCool.id)
...
Bitz.create(user_id: sally.id, bitz_def_id: usa_citizenship.id)
Bitz.create(user_id: sally.id, bitz_def_id: q_usa_citizenship.id)

us_dob = BitzDef.create(user_id:usa_government.id, name:'dob')
Bitz.create(user_id: sally.id, bitz_def_id: us_dob.id, value:'6.27.67')
